...
## Description:
[RSS Reader](frontend-project-lvl3-39uejvfft-m4xprd.vercel.app) is a service for aggregating RSS feeds that makes it easy to read a variety of sources, such as blogs or your favourite news. It allows you to add an unlimited number of RSS feeds, update them and add new entries to the whole stream.
<br></br>
**How to use it:**

• Find a blog or news feed, which you prefer to read

• Use RSS converters to make your blog/news link suitable for [RSS Reader](frontend-project-lvl3-39uejvfft-m4xprd.vercel.app)
